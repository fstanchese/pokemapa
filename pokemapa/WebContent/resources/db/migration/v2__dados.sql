INSERT INTO `pokemapa`.`pais` ( `nome`, `sigla`) VALUES 
( 'Brasil', 'BRA');
  
INSERT INTO `pokemapa`.`estado` ( `nome`, `uf`, `pais_id`) VALUES
( 'Acre', 'AC', 1),
( 'Alagoas', 'AL', 1),
( 'Amazonas', 'AM', 1),
( 'Amapá', 'AP', 1),
...
INSERT INTO `pokemapa`.`cidade` (`id`, `nome`, `estado_id`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO `pokemapa`.`tipo` (id, nome) values 
	(1, 'Pokestop'),
	(2, 'Ginásio');
