package br.com.pokeplace.googlemaps;
...
public class AddressConverter {
	...
	public static void main(String[] args) throws IOException {
		// ROOFTOP, GEOMETRIC_CENTER, RANGE_INTERPOLATED or APPROXIMATE
		GoogleResponse res = new AddressConverter().convertToLatLong("Rua do Acre - Vila Bertioga, São Paulo - SP, Brazil");
		...
		System.out.println("\n");
		String latlog = -23.5587254 + "," + -46.5817985;
		GoogleResponse res1 = new AddressConverter().convertFromLatLong(latlog);
